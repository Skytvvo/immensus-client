    ...
    <div v-else class="flex flex-col p-20 items-center">
      <div class="flex relative shadow-2xl gap-4 rounded-2xl p-8" style="width: 800px">
        ...
        <div class="flex flex-col justify-between">
          ...
          <button v-show="data?.state === 'ACTIVE'" class="border-2 border-gray-500 border-solid rounded-md p-2 hover:bg-emerald-600 hover:text-white" @click="() => cartStore.addByProductId(id as string)">Добавить в корзину</button>
        </div>
